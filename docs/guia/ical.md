...
- Tripadvisor
- Google Calendar
- Cualquier plataforma que exporte calendarios iCal (.ics)
...
4. El sistema valida la conexión inmediatamente

::: tip
Puedes conectar varias plataformas a un mismo alojamiento. Cada feed se sincroniza de forma independiente.
:::
...
Las plataformas que no incluyen datos de huéspedes en el calendario (como Booking.com) crean reservas sin huéspedes. Desde ahí puedes:
