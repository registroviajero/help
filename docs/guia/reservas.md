...
4. Se comprueba automáticamente que no haya solapamiento con otras reservas
...
Las reservas importadas que no incluyen datos de huéspedes se crean sin huéspedes — tú decides si añadir huéspedes o [bloquear las fechas](#bloqueo-de-fechas).
...
Usa la barra de búsqueda para encontrar reservas por:
- Nombre del huésped
- Número de documento
...
- **CSV** — exporta todas las reservas con filtros por estado, propiedad y fechas
