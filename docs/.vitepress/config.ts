...
const FAQS: Record<Locale, { q: string; a: string }[]> = {
  es: [
    ...
    { q: '¿Puede el huésped editar sus datos después de firmar?', a: 'Sí, mientras la reserva no esté bloqueada. En la pantalla final tiene un botón Editar mis datos. Si la reserva ya está en Enviado, Confirmado, Archivada o Bloqueado, el botón no aparece.' },
  ...
  en: [
    ...
    { q: 'Can the guest edit their data after signing?', a: 'Yes, while the reservation is not locked. On the final screen they have an Edit my information button. If the reservation is already in Sent, Confirmed, Archived, or Blocked, the button is hidden.' },
...
const PAGE_ALTERNATES: Record<Locale, string>[] = [
  ...
  { es: 'guia/revisar-reserva.md',           en: 'en/guide/review-reservation.md' },
  { es: 'guia/enviar.md',                    en: 'en/guide/submit.md' },
  { es: 'guia/corregir-rechazo-ministerio.md', en: 'en/guide/fix-ministry-rejection.md' },
...
const esSidebar: DefaultTheme.Sidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Revisar antes de enviar', link: '/guia/revisar-reserva' },
      { text: 'Validar y enviar', link: '/guia/enviar' },
      { text: 'Corregir rechazo del Ministerio', link: '/guia/corregir-rechazo-ministerio' },
    ],
  },
  {
    text: 'Gestión',
...
const enSidebar: DefaultTheme.Sidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Review before submitting', link: '/en/guide/review-reservation' },
      { text: 'Validate and submit', link: '/en/guide/submit' },
      { text: 'Fix Ministry rejection', link: '/en/guide/fix-ministry-rejection' },
    ],
  },
  {
    text: 'Management',
